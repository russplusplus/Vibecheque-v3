...
//   }
  ...
  const [number, setNumber] = useState(props.value ? props.value : props.defaultValue ? props.defaultValue : '')
  const [modalVisible, setModalVisible] = useState(false)
  const [countryCode, setCountryCode] = useState(props.defaultCode ? props.defaultCode : 'US')
